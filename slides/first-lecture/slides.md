...
> 💡 `./student.sh` 会显示 TUI 菜单，按 Enter 即可逐步开始实验，每步都有原理讲解、验证和提示。
...
每个实验的 `TUTORIAL.md` 在对应目录下：
```
labs/lab01-recon/TUTORIAL.md
labs/lab02-info-leak/TUTORIAL.md
...
```
...
- `labs/lab01-recon/TUTORIAL.md`
- `docs/TUTORIAL.md`（完整课程教程）
- `docs/diagrams/`（架构图、攻击链图）
